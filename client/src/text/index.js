...
export const livemusicHeader = "These are the bands I work with most. Between them, we cover everything from Heavy Metal to Frank Sinatra.";

//ProGear page text

export const progearHeader = "I am a dealer for selected pro gear that I actually use.";
export const progearSubheader = "As a working musician, quality, reliabilty, and responsive customer support are absolute requirements. All the lines I handle have those virtues.";
