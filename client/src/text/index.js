...
const homeText = {
    gnorm: {
        ...
        paragraph2: `Gnorm has been playing in bands since high school, including Split Decision (rock/power trio), Brother Clampett & the Brass Knuckle Horns (rock/blues), Hard Luck Harry (modern rock-90s), DNR (rocking doctors), Outside Chance (rock/dance/current hits), The Federation (rock--classic to eclectic), Shell Shockt (rock cover band) and the Cutouts (country-rockabilly).`,
        paragraph3: `Gnorm "lives by his ears" and will play any style of music. His signature skill is covering multiple guitar and keyboard parts on his guitar, prompting listeners to do a double take. Over the decades he has committed a sizable and varied repertoire of songs to memory, from Southern Rock to metal to rockabilly. Besides recording his bands' music demos, he has also contributed to friends' CDs and played a broad range of venues, from Toad's Place, the Levitt Pavilion and the Bartlett Arboretum, to local clubs and restaurants such as the Grey Goose, the Black Duck, and the Spotted Horse.`,
    }
};
